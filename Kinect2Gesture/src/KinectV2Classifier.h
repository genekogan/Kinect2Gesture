...
private:
    ...
    void eventAddClass(ofxControlButtonEventArgs & evt);
    void eventSave(ofxControlButtonEventArgs & evt);
    void eventLoad(ofxControlButtonEventArgs & evt);
    
    void eventSetRecording(ofxControlButtonEventArgs & evt);
    void eventSetPredicting(ofxControlButtonEventArgs & evt);
    ...
    float countStart, count;
    bool toRecord, toPredict;
